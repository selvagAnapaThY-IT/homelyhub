                ...
                <div className="booking-information col-lg-9 col-md-9">
                  ...
                  <div className="stay-information">
                    <span className="info">
                      ...
                      {booking.numberOfnights || booking.numberOfNights || booking.numberofnights || 1} nights
                    </span>
                    <span className="info">
                      <span className="material-symbols-outlined icon">
                        calendar_month
                      </span>
                      {new Date(booking.fromDate || booking.fromdate).toLocaleDateString()}
                    </span>
                    <span className="material-symbols-outlined icon">
                      arrow_forward
                    </span>
                    <span className="info">
                      ...
                      {new Date(booking.toDate || booking.todate).toLocaleDateString()}
                    </span>
                  </div>
